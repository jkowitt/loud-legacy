...
-- Step 1: Create or update the demo user account (password: demo123)
...
ON CONFLICT (email) DO UPDATE SET
  password = '$2a$10$CoNB03ab5x6tieqKeF1pR.uM1NFd2W..qgXoZzGrmhGLvxVe9U4yO',
  role = 'SUPER_ADMIN',
  name = 'Demo Admin',
  "updatedAt" = NOW();
...
SELECT
  ...
  STRING_AGG(pa.platform::text, ', ' ORDER BY pa.platform) as platforms
FROM "User" u
