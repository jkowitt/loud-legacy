      ...
      <section className="section">
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <p style={{ color: "var(--color-text-secondary)", marginBottom: "var(--space-4)" }}>
            ...
            venue technology, and business operations tools. We discovered the same customers needed connected workflows,
          ...
          <p style={{ color: "var(--color-text-secondary)", marginBottom: "var(--space-4)" }}>
            ...
            growth, Sportify for live event execution, and Legacy CRM for relationship management. The hub coordinates
            the product roadmap, storytelling, and go-to-market motions.
          </p>
